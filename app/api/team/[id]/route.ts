...
export async function GET(request: NextRequest, { params }: TeamRouteParams): Promise<NextResponse> {
  try {
...
export async function PUT(request: NextRequest, { params }: TeamRouteParams): Promise<NextResponse> {
  try {
    const { id } = await params;
    const objId = parseId(id);
    if (!objId) {
...
export async function DELETE(request: NextRequest, { params }: TeamRouteParams): Promise<NextResponse> {
  try {
    const { id } = await params;
    const objId = parseId(id);
    if (!objId) {
