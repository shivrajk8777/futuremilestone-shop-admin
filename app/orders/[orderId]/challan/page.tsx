          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-gray-500 uppercase tracking-widest font-bold block mt-1">Official Fulfillment Studio</span>
              </div>
            </div>
            <p className="text-[11px] text-gray-600 mt-3 leading-relaxed">
              108 Studio Lane, Industrial Area,<br />
              Mumbai, MH, 400013<br />
              Email: info@futuremilestone.shop | Phone: +91 (022) 8940-2011
            </p>
          </div>
