    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.8fr)] gap-3 mt-1">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="bg-futuremilestone-panel-strong border border-futuremilestone-soft-line rounded-[24px] p-6 text-sm leading-relaxed whitespace-pre-wrap text-futuremilestone-ink/95 font-medium shadow-futuremilestone-soft">
              {contact.message}
            </div>
          </PageSection>
            ...
            >
              <div className="space-y-3">
                {contact.replies.map((reply: any, idx: number) => (
                  <div
                    key={idx}
                    className="bg-futuremilestone-panel-strong border border-futuremilestone-soft-line rounded-[24px] p-5 shadow-futuremilestone-soft space-y-3.5 animate-fade-in"
                  >
                    <div className="flex items-center justify-between text-[11px] font-bold text-futuremilestone-muted uppercase tracking-wider">
                      <span className="truncate max-w-[70%]">Subject: {reply.subject}</span>
                      <span>{formatDate(reply.sentAt)}</span>
                    </div>
                    <p className="text-futuremilestone-ink/90 text-[13px] leading-relaxed whitespace-pre-wrap font-medium">
                      {reply.message}
                    </p>
                  </div>
                ))}
        ...
        <div className="space-y-3">
          <PageSection title="Inquiry Status">
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-4 border-b border-futuremilestone-soft-line/60 pb-3 text-[13px]">
                <span className="text-futuremilestone-muted">Status:</span>
              ...
              <div className="flex items-center justify-between gap-4 border-b border-futuremilestone-soft-line/60 pb-3 text-[13px]">
                <span className="text-futuremilestone-muted">Responses sent:</span>
                <span className="font-semibold text-futuremilestone-ink">
                  {contact.replies.length}
                </span>
              </div>

              <div className="text-[13px]">
                <span className="text-futuremilestone-muted block">Submitted on:</span>
                <span className="font-semibold text-futuremilestone-ink block mt-0.5">
          ...
          <PageSection title="Customer Details">
            <div className="space-y-3 text-[13px] text-futuremilestone-ink">
              <div>
                <span className="block text-[10px] uppercase font-bold tracking-wider text-futuremilestone-muted">Name</span>
                <span className="font-semibold text-[14px]">{contact.name}</span>
              </div>
              <div className="border-t border-futuremilestone-soft-line pt-3">
                <span className="block text-[10px] uppercase font-bold tracking-wider text-futuremilestone-muted">Email Address</span>
                <a
                  href={`mailto:${contact.email}`}
                  className="font-semibold text-futuremilestone-accent hover:underline block truncate mt-0.5"
                >
                  {contact.email}
                </a>
              </div>
